...
const About: React.FC = () => {
  return (
    <section className="w-full mt-24" id="#about">
          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-700 dark:text-gray-300 md:text-xl">
                ...
                environments, helping them apply classroom knowledge to
                practical scenarios and develop essential skills for their
                future careers. Overall, the Internhub Cell strives to empower
                students to become versatile, adaptable professionals prepared
